...
import { useResolvedPath, useMatch, useLocation, matchPath, NavLink } from 'react-router-dom';
	...
	return (
		<div id="app-top-menu" className="menu">
			...
			<div className="menu-item menu-control menu-control-start">
				{/* <a className="menu-link" href="/" ><i className="fa fa-angle-left"></i></a> */}
			</div>
			<div className="menu-item menu-control menu-control-end">
				{/* <a className="menu-link" href="/" ><i className="fa fa-angle-right"></i></a> */}
			</div>
		</div>
	);
}
